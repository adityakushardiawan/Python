...
while True: 
    ...
    hour = int(input("Year (YYYY):"))
    minute = int(input("Month (1-12):"))
    second = int(input("Day (1-31):"))
    trans['trans_date'] = datetime.datetime(hour,minute,second)
    ...
    for b in data_transaction:
        KEY = b
        prod = data_transaction[KEY]['product']
